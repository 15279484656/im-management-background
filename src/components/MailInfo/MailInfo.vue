    ...
    <div class="content-main">
      <div class="filter-box">
        <el-form :inline="true" :model="filterForm" class="demo-form-inline">
          ...
          <el-form-item>
            ...
            <el-button type="primary" @click="handleAddNew">新增信件</el-button>
          </el-form-item>
        </el-form>
      </div>
      <div class="form-table-box">
        <el-table :data="tableData" style="width: 100%" border stripe>
          ...
          <el-table-column prop="toNickName" label="接收人昵称" width="150"/>
...
export default {
  ...
  methods: {
    ...
    handleRowEdit(index, row) {
      this.$router.push({name: 'mail_info_add', query: {id: row.id}});
    },
    handleRowDelete(index, row) {
      this.$confirm('确定要删除这条记录吗？', '提示', {
        ...
        this.axios.delete('/imchat/mailInfo', {params: {id: row.id}}).then(response => {
    ...
    handleAddNew() {
      this.$router.push({name: 'mail_info_add'});
    },
    onSubmitFilter() {
      this.page = 1;
      this.pageSize = 10;
    ...
    getList() {
      ...
      this.axios.get('/imchat/mailInfo/page', {params})
          .then(response => {
            if (response.data.success) {
